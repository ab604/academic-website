...
It presents a picture of a University full of software users and developers in need of
...
survey and how it compares with the authors own description. I was struck by the omission of Microsoft Office or Safari or
other well known brand names from the description of what software is. Given the ubiquity of
MS Office in generating research results I wonder what an A-B version of survey
...
```{r q1}
knitr::include_graphics("survey-img/q1.png")
```
```{r q2}
knitr::include_graphics("survey-img/q2.png")
```
```{r q3}
knitr::include_graphics("survey-img/q3.png")
```
```{r q4}
knitr::include_graphics("survey-img/q4.png")
```
```{r q5}
knitr::include_graphics("survey-img/q5.png")
```
```{r q6}
knitr::include_graphics("survey-img/q6.png")
```
```{r q7}
knitr::include_graphics("survey-img/q7.png")
```
```{r q8}
knitr::include_graphics("survey-img/q8.png")
```
```{r q9}
knitr::include_graphics("survey-img/q9.png")
```
```{r q10}
knitr::include_graphics("survey-img/q10.png")
```
```{r q11}
knitr::include_graphics("survey-img/q11.png")
```
```{r q12}
knitr::include_graphics("survey-img/q12.png")
```
