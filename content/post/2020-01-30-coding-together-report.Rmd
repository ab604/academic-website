...
The course materials exist as an [online book]((https://ab604.github.io/docs/coding-together-2019/)) 
and some [accompying slides](https://ab604.github.io/docs/coding-together-slides-2019/lesson-slides-2019.html#1).
...
who in 2015 didn't regard myself as someone who coded, but realised that I needed to learn to
...
struggling with their data too, but unsure of how
to get started, and learning in largely ad-hoc ways.(This also reflected in the answers 
to [data skills survey](#data-survey) below.) This observation led me to join the Carpentries community and my involvement
...
code informally through their use of Excel, Graphpad, Google, and other software, who would
...
do so within the University. Thirdly, that whilst this requires support from the top
- those with the money and power - the form of the solutions should be community driven.
A big reason why Coding togetheR is sub-optimal is that it has largely been driven by
me, with all the errors and biases that I bring as an individual, when many eyes would optimise.
I'm not sure what Universities think they are for any more,
...
but this was very much starting [*where I am, with what we have and who is around me*](https://teachtogether.tech/#s:community), 
...
Greg Wilson's advice about [building relationships](https://teachtogether.tech/#s:outreach-final),
particularly with some social scientists and the rest of the [Research Software Group](https://rsgsoton.net/).

I should also note here that a broader survey was carried out by the Research Software Group
at the University of Southampton in 2019. It was broader in the sense that it aimed
to survey software development as well as use, across all levels of expertise, rather
than my focus on those who don't think of themselves as software users/coders, and on tool use. 
It presents a picture of a University full of free ranging software users and developers in need of
better support, however it's limited by the issue of capturing only those who responded to the email, 
and are comfortable with the language of computer science such as *"script"* or *"clean some data"*.
I'd be interested to see a question about how people from different disciplines interpret the word *"software"* in another
survey and how it compares with the authors own description. I was struck by the omission of Microsoft Office or Google or
other well known brand names from the description of what software is. Given the ubiquity of
MS Office in generating research results, and search engines as a tool, I wonder what an A-B version of survey
with a more technical versus less technical description would have done to the survey answers? Possibly nothing!
But I guess that's one motivation for engaging social scientists in this challenge.
The full report can be found [here](https://github.com/Southampton-RSG/soton_software_survey_analysis_2019/raw/master/report/Research%20software%20at%20the%20University%20of%20Southampton.pdf).
